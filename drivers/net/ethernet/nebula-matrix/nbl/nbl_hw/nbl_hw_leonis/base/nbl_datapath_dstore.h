...
#define NBL_DSTORE_BUF_TOTAL_TURN_PKT_ADDR  (0x7050ac)
#define NBL_DSTORE_BUF_TOTAL_TURN_PKT_DEPTH (1)
#define NBL_DSTORE_BUF_TOTAL_TURN_PKT_WIDTH (32)
#define NBL_DSTORE_BUF_TOTAL_TURN_PKT_DWLEN (1)
union dstore_buf_total_turn_pkt_u {
	struct dstore_buf_total_turn_pkt {
		u32 cnt:32;              /* [31:0] Default:0x0 SCTR */
	} __packed info;
	u32 data[NBL_DSTORE_BUF_TOTAL_TURN_PKT_DWLEN];
} __packed;
...
#define NBL_DSTORE_BUF_PORT_TURN_PKT_ADDR  (0x706540)
#define NBL_DSTORE_BUF_PORT_TURN_PKT_DEPTH (12)
#define NBL_DSTORE_BUF_PORT_TURN_PKT_WIDTH (32)
#define NBL_DSTORE_BUF_PORT_TURN_PKT_DWLEN (1)
union dstore_buf_port_turn_pkt_u {
	struct dstore_buf_port_turn_pkt {
		u32 cnt:32;              /* [31:0] Default:0x0 SCTR */
	} __packed info;
	u32 data[NBL_DSTORE_BUF_PORT_TURN_PKT_DWLEN];
} __packed;
#define NBL_DSTORE_BUF_PORT_TURN_PKT_REG(r) (NBL_DSTORE_BUF_PORT_TURN_PKT_ADDR + \
		(NBL_DSTORE_BUF_PORT_TURN_PKT_DWLEN * 4) * (r))
