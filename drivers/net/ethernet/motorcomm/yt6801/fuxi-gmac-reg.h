...
#define FXGMAC_REV_01 0x01
#define FXGMAC_REV_03 0x03
...
#define MAC_MDIO_ADDRESS_BUSY 1
...
#define RX_NORMAL_DESC0_WB_OVT_POS 0
#define RX_NORMAL_DESC0_WB_OVT_LEN 16
#define RX_NORMAL_DESC0_WB_OVT_VLANID_POS 0
#define RX_NORMAL_DESC0_WB_OVT_VLANID_LEN 12
#define RX_NORMAL_DESC0_WB_OVT_CFI_POS 12
#define RX_NORMAL_DESC0_WB_OVT_CFI_LEN 1
#define RX_NORMAL_DESC0_WB_OVT_PRIO_POS 13
#define RX_NORMAL_DESC0_WB_OVT_PRIO_LEN 3

#define RX_NORMAL_DESC1_WB_IPCE_POS 7
#define RX_NORMAL_DESC1_WB_IPCE_LEN 1
#define RX_NORMAL_DESC1_WB_IPV6_POS 5
#define RX_NORMAL_DESC1_WB_IPV6_LEN 1
#define RX_NORMAL_DESC1_WB_IPV4_POS 4
#define RX_NORMAL_DESC1_WB_IPV4_LEN 1
#define RX_NORMAL_DESC1_WB_IPHE_POS 3
...
#define TX_CONTEXT_DESC2_IVLTV_POS 16
...
#define TX_NORMAL_DESC3_CIC_POS \
	16 /* Checksum Insertion Control or TCP Payload Length.
...
#define TX_NORMAL_DESC3_TCPHDRLEN_POS \
	19 /* THL: TCP/UDP Header Length.If the TSE bit is set, this field contains
...
#define FXGMAC_EPHY_REGS_LEN 32

#define REG_MII_BMCR 0x00
...
#define REG_MII_BMSR 0x01
#define REG_MII_PHYSID1 0x02
#define REG_MII_PHYSID2 0x03
#define REG_MII_ADVERTISE 0x04
...
#define REG_MII_EXPANSION 0x06
#define REG_MII_NEXT_PAGE 0x07
#define REG_MII_LPR_NEXT_PAGE 0x08
#define REG_MII_CTRL1000 0x09
...
#define PHY_INT_MASK_LINK_DOWN_LEN 1
#endif
#define REG_MII_INT_STATUS 0x13
...
#define REG_MII_DOWNG_CTRL 0x14
#define REG_MII_RERRCOUNTER 0x15

#define REG_MII_EXT_ADDR 0x1e
#define REG_MII_EXT_DATA 0x1f
 ...
 */
#define FXGMAC_ADVERTISE_SLCT 0x001f
#define FXGMAC_ADVERTISE_CSMA 0x0001
#define FXGMAC_ADVERTISE_1000FULL 0x0004
#define FXGMAC_ADVERTISE_1000HALF 0x0008
#define FXGMAC_ADVERTISE_10HALF 0x0020
#define FXGMAC_ADVERTISE_10FULL 0x0040
#define FXGMAC_ADVERTISE_100HALF 0x0080
#define FXGMAC_ADVERTISE_100FULL 0x0100
#define FXGMAC_ADVERTISE_100BASE4 0x0200
#define FXGMAC_ADVERTISE_PAUSE_CAP 0x0400
#define FXGMAC_ADVERTISE_PAUSE_ASYM 0x0800
#define FXGMAC_ADVERTISE_RESV 0x1000
#define FXGMAC_ADVERTISE_RFAULT 0x2000
#define FXGMAC_ADVERTISE_LPACK 0x4000
#define FXGMAC_ADVERTISE_NPAGE 0x8000

/* 1000BASE-T Control register(0x09) */
#define REG_BIT_ADVERTISE_1000FULL 0x0200
#define REG_BIT_ADVERTISE_1000HALF 0x0100

#define REG_BIT_ADVERTISE_1000_CAP \
	(REG_BIT_ADVERTISE_1000FULL | REG_BIT_ADVERTISE_1000HALF)
...
#define MGMT_EPHY_CTRL_STA_EPHY_RESET 0
#define MGMT_EPHY_CTRL_STA_EPHY_RELEASE 1
#define MGMT_EPHY_CTRL_STA_EPHY_LINKUP 2
#define MGMT_EPHY_CTRL_STA_EPHY_LINKUP_POS 1
#define MGMT_EPHY_CTRL_STA_EPHY_LINKUP_LEN 1
#define MGMT_EPHY_CTRL_STA_EPHY_DUPLEX_POS 2
...
#define INT_CTRL1_TMR_CNT_CFG_MAX_POS \
	0 /* Timer counter cfg max. Default 0x19, 1us. */
...
#define LTR_CTRL_IDLE_THRE_TIMER_LEN 14
...
#define LTR_IDLE_ENTER \
	0x113c /* LTR_CTRL3, LTR latency message, only for System IDLE Start. */
...
#define LTR_IDLE_ENTER_SCALE \
	2 /* 0-1ns, 1-32ns, 2-1024ns, 3-32,768ns, 4-1,048,576ns, 5-33,554,432ns, 110-111-Not Permitted.*/
#define LTR_IDLE_ENTER_REQUIRE_POS 15
#define LTR_IDLE_ENTER_REQUIRE_LEN 1
#define LTR_IDLE_ENTER_REQUIRE 1

#define LTR_IDLE_EXIT \
	0x1140 /* LTR_CTRL4, LTR latency message, only for System IDLE End. */
...
#define LPW_CTRL_L1SS_SEL_POS \
	21 /* 0 - up to both CFG0x158 and reg1188 L1ss setting. 1 - up to CFG0x158 L1ss setting. */
#define LPW_CTRL_L1SS_SEL_LEN 1
#define LPW_CTRL_L1SS_SEL_CFG 1
#define LPW_CTRL_ASPM_L1_CPM_POS \
	19 /*L1.CPM mode enable bit. Default 0,set as 1 enable this mode. clkreq pin need to connect RC*/
...
#define LPW_CTRL_SYS_CLK_125_SEL_POS \
	8 /* system 125M select: 125M or 62.5MHz. Default: 125MHz.*/
#define LPW_CTRL_SYS_CLK_125_SEL_LEN 1
#define LPW_CTRL_PCIE_RADM_CG_EN_POS \
	5 /* clock gating enable bit of PCIe Radm clock. Default 1; set as 1, enable gating.*/
#define LPW_CTRL_PCIE_RADM_CG_EN_LEN 1
#define LPW_CTRL_PCIE_CORE_CG_EN_POS \
	4 /* clock gating enable bit of PCIe Core clock. Default 1; set as 1, enable gating.*/
#define LPW_CTRL_PCIE_CORE_CG_EN_LEN 1
#define LPW_CTRL_PCIE_AXI_CG_EN_POS \
	3 /* clock gating enable bit of PCIe AXI clock.Default 1; set as 1, enable gating.*/
#define LPW_CTRL_PCIE_AXI_CG_EN_LEN 1
#define LPW_CTRL_GMAC_AXI_CG_EN_POS \
	2 /* clock gating enable bit of GMAC AXI clock. Default 1; set as 1, enable gating.*/
#define LPW_CTRL_GMAC_AXI_CG_EN_LEN 1
#define LPW_CTRL_MDIO2APB_CG_EN_POS \
	1 /* clock gating enable bit of MDIO2APB, default 1. Set as 1, enable clock gating feature. */
#define LPW_CTRL_MDIO2APB_CG_EN_LEN 1
#define LPW_CTRL_OTP_CLK_ON_POS \
	0 /* Turn on before SW OTP operation, default 1. */
...
#define REG_PCIE_PSM_STATE 0x1994
...
#define REG_PCI_VENDOR_ID 0x0
#define REG_PCI_DEVICE_ID 0x2
...
#define REG_PCI_REVID 0x8
#define REG_PCI_PROGRAM_INTF 0x9
#define REG_PCI_SUB_CLASS 0xa
#define REG_PCI_BASE_CLASS 0xb
#define REG_CACHE_LINE_SIZE 0xc

#define REG_MEM_BASE 0x10
#define REG_MEM_BASE_HI 0x14

#define REG_IO_BASE 0x20

#define REG_PCI_SUB_VENDOR_ID 0x2c
#define REG_PCI_SUB_DEVICE_ID 0x2e

#define REG_INT_LINE 0x3c

#define REG_PM_STATCTRL 0x44
...
#define ASPM_L1SS_CTRL1_CM_RESTORE_TIME_POS 8
#define ASPM_L1SS_CTRL1_CM_RESTORE_TIME_LEN 8
#define ASPM_L1SS_CTRL1_LTR_L12_TH_VALUE_POS 16
#define ASPM_L1SS_CTRL1_LTR_L12_TH_VALUE_LEN 10
#define ASPM_L1SS_CTRL1_L12_TH_SCALE_POS 29
#define ASPM_L1SS_CTRL1_L12_TH_SCALE_LEN 3

#define REG_ASPM_L1SS_CTL2 0x15c
...
#define ASPM_L1_IDLE_THRESHOLD_8US 3
