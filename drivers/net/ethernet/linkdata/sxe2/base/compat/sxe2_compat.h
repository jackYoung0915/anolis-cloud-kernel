...
#undef HAVE_MACSEC_SUPPORT
#undef SUPPORT_ETHTOOL_GET_RMON_STATS
#undef HAVE_NDO_XSK_WAKEUP
#undef HAVE_NETDEV_BPF_XSK_POOL
#undef HAVE_MEM_TYPE_XSK_BUFF_POOL
#undef HAVE_XDP_BUFF_RXQ
#undef HAVE_AF_XDP_ZC_SUPPORT
#undef XSK_UMEM_RETURNS_XDP_DESC
#undef HAVE_XDP_BUFF_FRAME_SZ
#undef HAVE_AF_XDP_NETDEV_UMEM
#undef IPSEC_HAVE_REAL_DEV
#undef SUPPORTED_FLASH_UPDATE_PARAMS
#undef HAVE_NDO_ETH_IOCTL
#undef HAVE_FLOW_INDR_BLOCK_API
#define GET_RINGPARAM_NEED_2_PARAMS
#define SET_RINGPARAM_NEED_2_PARAMS
#define GET_COALESCE_NEED_2_PARAMS
#define SET_COALESCE_NEED_2_PARAMS
...
#define NEED_DEFINE_ETH_HW_ADDR_SET
#define NEED_DEFINE_DEV_PAGE_IS_REUSABLE
