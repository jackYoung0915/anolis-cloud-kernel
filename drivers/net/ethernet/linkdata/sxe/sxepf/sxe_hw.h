...
s32 sxe_rcv_msg_from_vf_lock(struct sxe_hw *hw, u32 *msg, u16 msg_len,
			     u16 index);

s32 sxe_send_msg_to_vf_lock(struct sxe_hw *hw, u32 *msg, u16 msg_len,
			    u16 index);
...
void sxe_hw_rss_redir_tbl_set_by_idx(struct sxe_hw *hw,	u16 reg_idx,
				     u32 value);
