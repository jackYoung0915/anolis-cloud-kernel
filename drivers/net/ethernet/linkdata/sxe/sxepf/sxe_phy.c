...
static void sxe_sfp_cfg_info_set(struct sxe_adapter *adapter)
{
	...
	LOG_INFO_BDF("sfp cfg set start\n");
	...
	LOG_INFO_BDF("sfp vendor name is:\n"
		     "\t0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x,\n"
		     "\t0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x\n",
		     vendor_name[0], vendor_name[1], vendor_name[2],
		     vendor_name[3], vendor_name[4], vendor_name[5],
		     vendor_name[6], vendor_name[7], vendor_name[8],
		     vendor_name[9], vendor_name[10], vendor_name[11],
		     vendor_name[12], vendor_name[13], vendor_name[14],
		     vendor_name[15]);
	...
	LOG_INFO_BDF("sfp vendor pn is:\n"
		     ...
		     vendor_pn[12], vendor_pn[13], vendor_pn[14],
		     vendor_pn[15]);

	LOG_INFO_BDF("sfp quirk info get end\n");
