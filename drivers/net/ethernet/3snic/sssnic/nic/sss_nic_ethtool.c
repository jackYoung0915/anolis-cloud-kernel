...
static int sss_nic_get_coalesce(struct net_device *netdev, struct ethtool_coalesce *coal,
				...
				struct netlink_ext_ack __maybe_unused *extack)
#else
static int sss_nic_get_coalesce(struct net_device *netdev,
...
static int sss_nic_set_coalesce(struct net_device *netdev, struct ethtool_coalesce *coal,
				...
				struct netlink_ext_ack __maybe_unused *extack)
#else
static int sss_nic_set_coalesce(struct net_device *netdev,
				struct ethtool_coalesce *coal)
#endif
{
...
static const struct ethtool_ops g_nic_ethtool_ops = {
#ifdef HAS_ETHTOOL_SUPPORTED_COALESCE_PARAMS
	...
	.get_settings = sss_nic_get_settings,
	.set_settings = sss_nic_set_settings,
#endif
...
#else
	.get_rxfh_indir = sss_nic_get_rxfh_indir,
	.set_rxfh_indir = sss_nic_set_rxfh_indir,
#endif
};
