...
int sss_nic_get_rxfh(struct net_device *netdev, struct ethtool_rxfh_param *rxfh_param);
#else
...
#ifdef HAVE_RXFH_HASHFUNC
#ifdef HAVE_RXFH_PARAM
int sss_nic_set_rxfh(struct net_device *netdev, struct ethtool_rxfh_param *rxfh_param,
