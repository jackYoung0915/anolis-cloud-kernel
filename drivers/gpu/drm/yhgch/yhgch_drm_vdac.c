...
static enum drm_mode_status yhgch_connector_mode_valid(struct drm_connector
							*connector,
...
static struct drm_encoder *yhgch_connector_best_encoder(struct drm_connector
							 *connector)
{
...
static const struct drm_connector_helper_funcs yhgch_connector_helper_funcs = {
	.get_modes = yhgch_connector_get_modes,
	.mode_valid = yhgch_connector_mode_valid,
	.best_encoder = yhgch_connector_best_encoder,
};
...
static const struct drm_encoder_funcs yhgch_encoder_funcs = {
...
int yhgch_vdac_init(struct yhgch_drm_private *priv)
{
	...
	ret = drm_encoder_init(dev, encoder, &yhgch_encoder_funcs,
