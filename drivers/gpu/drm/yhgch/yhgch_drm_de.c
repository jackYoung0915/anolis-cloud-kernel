...
static const struct yhgch_dislay_pll_config yhgch_pll_table[] = {
	{ 640, 480, 60,  CRT_PLL1_NS_25MHZ, CRT_PLL2_NS_25MHZ },
	{ 800, 600, 60, CRT_PLL1_NS_40MHZ, CRT_PLL2_NS_40MHZ },
	{ 1024, 768, 60, CRT_PLL1_NS_65MHZ, CRT_PLL2_NS_65MHZ },
	{ 1280, 1024, 60, CRT_PLL1_NS_108MHZ, CRT_PLL2_NS_108MHZ },
	{ 1920, 1080, 60, CRT_PLL1_NS_148MHZ, CRT_PLL2_NS_148MHZ },
	{ 1920, 1200, 60, CRT_PLL1_NS_193MHZ, CRT_PLL2_NS_193MHZ },
};
...
static void get_pll_config(unsigned long x, unsigned long y, unsigned int vrefresh,
			   u32 *pll1, u32 *pll2)
{
	int i;
	...
	for (i = 0; i < count; i++) {
		if (yhgch_pll_table[i].hdisplay == x &&
		    yhgch_pll_table[i].vdisplay == y && yhgch_pll_table[i].vrefresh == vrefresh) {
					...
					unsigned int ctrl)
{
	...
	get_pll_config(x, y, vrefresh, &pll1, &pll2);
