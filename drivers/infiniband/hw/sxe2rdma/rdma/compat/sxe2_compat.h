...
#define NETIF_NAPI_ADD_API_NEED_4_PARAMS
#define RDMA_IRQ_UPDATE_AFFINITY
#define GLOBAL_QP_MEM_NOT_SUPPORT
...
#define GET_NETDEV_OP_V1
#define REG_USER_MR_DMABUF_VER_1
#define CREATE_AH_NOT_SUPPORT
#define HAVE_IB_UMEM_SG_HEAD
