...
static const struct pci_device_id sp_pci_table[] = {
	...
	{ PCI_VDEVICE(HYGON, 0x14a6), (kernel_ulong_t)&dev_vdata[6] },
	{ PCI_VDEVICE(HYGON, 0x14d8), (kernel_ulong_t)&dev_vdata[2] },
	{ PCI_VDEVICE(HYGON, 0x14c6), (kernel_ulong_t)&dev_vdata[6] },
