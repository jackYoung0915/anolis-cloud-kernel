...
static int virtblk_get_ext_feature_bar(struct virtio_device *vdev, u32 *bar_offset)
{
...
static int virtblk_get_ext_feature(void __iomem *ioaddr, u32 *host_features)
{
	int ret;
...
static void virtblk_set_ext_feature(void __iomem *ioaddr, u32 guest_ext_features)
{
