...
static struct page *kho_restore_page(phys_addr_t phys)
{
	 ...
	 */
	if (WARN_ON_ONCE(info.magic != KHO_PAGE_MAGIC || info.order > MAX_ORDER))
		return NULL;
...
int kho_preserve_vmalloc(void *ptr, struct kho_vmalloc *preservation)
{
	...
	/*
	 * Backporting issue: get_vm_area_page_order() is in a large patch,
	 * this is ugly but simple, as original function is just a wrapper.
	 */
