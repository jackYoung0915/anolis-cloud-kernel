...
#endif
SCHED_FEAT(NUMA_AFFINE, false)
SCHED_FEAT(ID_BOOK_CPU, false)
SCHED_FEAT(ID_LOAD_BALANCE, false)
#ifdef CONFIG_GROUP_IDENTITY
SCHED_FEAT(ID_ABSOLUTE_EXPEL, false)
SCHED_FEAT(GROUP_IDENTITY_PREEMPT, false)
#ifdef CONFIG_SCHED_CORE
SCHED_FEAT(ID_SMT_EXPEL, false)
#endif
#ifdef CONFIG_SMP
SCHED_FEAT(ID_PUSH_EXPELLEE, false)
SCHED_FEAT(ID_PUSH_EXPELLEE_CONSIDER_HIGHCLASS, true)
#endif
#ifdef CONFIG_SCHED_CORE
...
SCHED_FEAT(SCHED_FEAT_RESERVE4, false)
SCHED_FEAT(SCHED_FEAT_RESERVE5, false)
SCHED_FEAT(SCHED_FEAT_RESERVE6, false)
SCHED_FEAT(SCHED_FEAT_RESERVE7, false)
SCHED_FEAT(SCHED_FEAT_RESERVE8, false)
