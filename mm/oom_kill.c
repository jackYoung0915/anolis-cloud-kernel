							   ...
							   bool is_memcg)
{
...
#ifdef CONFIG_PRINTK
	if (is_memcg && __ratelimit(&oom_memcg_rs))
		suppress_print = true;
#endif
	...
	report_fault_event(raw_smp_processor_id(), victim,
	...
	for_each_process(p) {
		...
		report_fault_event(raw_smp_processor_id(), p, NORMAL_FAULT,
...
bool out_of_memory(struct oom_control *oc)
{
	...
	report_fault_event(raw_smp_processor_id(), current, NORMAL_FAULT,
