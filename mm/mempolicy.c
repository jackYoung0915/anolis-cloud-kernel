...
#undef vma_alloc_folio
extern typeof(vma_alloc_folio_noprof) vma_alloc_folio __attribute__((alias("vma_alloc_folio_noprof")));
...
/* kapi: preserve original exported symbol */
#undef alloc_pages
extern typeof(alloc_pages_noprof) alloc_pages __attribute__((alias("alloc_pages_noprof")));
