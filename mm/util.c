...
#undef kmemdup
extern __malloc typeof(kmemdup_noprof) kmemdup __attribute__((alias("kmemdup_noprof")));
...
/* kapi: preserve original exported symbol */
#undef kvmalloc_node
extern __malloc typeof(kvmalloc_node_noprof) kvmalloc_node __attribute__((alias("kvmalloc_node_noprof")));
