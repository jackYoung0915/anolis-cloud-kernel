...
mempool_t *mempool_create(int min_nr, mempool_alloc_t *alloc_fn,
			  mempool_free_t *free_fn, void *pool_data)
{
	return mempool_create_node_noprof(min_nr, alloc_fn, free_fn, pool_data,
...
/* kapi: preserve original exported symbol */
#undef mempool_alloc
extern __malloc typeof(mempool_alloc_noprof) mempool_alloc __attribute__((alias("mempool_alloc_noprof")));
