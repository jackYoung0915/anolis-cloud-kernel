...
function do_prep() {
    ...
    ${DIST_RPMBUILDDIR_OUTPUT}/SOURCES/kernel-${DIST_KERNELVERSION}-loongarch.config
    cp ${DIST_OUTPUT}/kernel-ANCK-debug-loongarch.config \
    ${DIST_RPMBUILDDIR_OUTPUT}/SOURCES/kernel-${DIST_KERNELVERSION}-loongarch-debug.config
}
