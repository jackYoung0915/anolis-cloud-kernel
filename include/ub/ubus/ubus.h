...
struct ub_bus_controller {
	...
	CK_CK_KABI_RESERVE(1)
	CK_CK_KABI_RESERVE(2)
	CK_CK_KABI_RESERVE(3)
	CK_CK_KABI_RESERVE(4)
};
...
static inline void ub_iommu_fwnode_handle_set(const struct fwnode_handle *fwnode) {}
static inline const struct fwnode_handle *ub_iommu_fwnode_handle_get(void)
{ return NULL; }
