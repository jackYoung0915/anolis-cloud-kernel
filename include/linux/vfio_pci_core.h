...
extern int vfio_pci_dma_fault_init(struct vfio_pci_core_device *vdev, bool register_fault);
extern int vfio_pci_set_ext_irq_trigger(struct vfio_pci_core_device *vdev,
