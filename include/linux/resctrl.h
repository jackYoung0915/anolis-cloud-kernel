...
/*
 * Resctrl uses a unsigned long as a closid bitmap. The maximum closid is size
 * of unsigned long.
 */
#define RESCTRL_MAX_CLOSID		BITS_PER_LONG
...
#define RESCTRL_ID_CLOSID	GENMASK(31, 0)
...
resctrl_get_domain_from_cpu(int cpu, struct rdt_resource *r)
{
	...
	list_for_each_entry_rcu(d, &r->domains, hdr.list) {
