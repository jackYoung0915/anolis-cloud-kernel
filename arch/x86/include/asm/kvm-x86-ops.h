...
KVM_X86_OP_OPTIONAL(pre_update_apicv_exec_ctrl)
...
KVM_X86_OP(sched_in)
KVM_X86_OP_OPTIONAL(slot_enable_log_dirty)
KVM_X86_OP_OPTIONAL(slot_disable_log_dirty)
KVM_X86_OP_OPTIONAL(flush_log_dirty)
KVM_X86_OP_OPTIONAL(enable_log_dirty_pt_masked)
KVM_X86_OP_OPTIONAL(pre_block)
KVM_X86_OP_OPTIONAL(post_block)
...
KVM_X86_OP_OPTIONAL(mem_enc_op)
KVM_X86_OP_OPTIONAL(mem_enc_reg_region)
KVM_X86_OP_OPTIONAL(mem_enc_unreg_region)
