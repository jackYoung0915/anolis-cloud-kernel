...
#define VMCS_ZX_TERTIARY_CONTROL_BIT(x)	BIT(VMX_ZX_TERTIARY_FEATURE_##x & 0x1f)
 ...
 */
#define ZX_TERTIARY_EXEC_GUEST_PAUSEOPT VMCS_ZX_TERTIARY_CONTROL_BIT(GUEST_PAUSEOPT)
