...
{
	struct trace_point *tp = container_of(work, struct trace_point, dump_work);
...
void try_dump_skb(struct sk_buff *skb, struct trace_point *tp)
{
...
void init_dump_work(struct trace_point *tp)
{
