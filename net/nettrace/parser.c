...
const struct inet_proto proto4[] = {
		{.number = 0, .name = "ip"},
		{.number = 1, .name = "icmp"},
		{.number = 2, .name = "igmp"},
		{.number = 4, .name = "ipip"},
...
const int proto4_len = sizeof(proto4) / sizeof(struct inet_proto);

const struct inet_proto proto3[] = {
...
const int proto3_len = sizeof(proto3) / sizeof(struct inet_proto);
...
static
int str2proto(char *proto_str, struct inet_proto proto[], int len)
{
	int i = 0;
...
static
char *proto2str(int proto, struct inet_proto protos[], int len)
{
	int i = 0;
...
{
	return str2proto(proto_str, (struct inet_proto *) proto3, proto3_len);
}

int str2proto4(char *proto_str)
{
	return str2proto(proto_str, (struct inet_proto *) proto4, proto4_len);
}

char *proto3tostr(int p)
{
	return proto2str(p, (struct inet_proto *) proto3, proto3_len);
}

char *proto4tostr(int p)
{
	return proto2str(p, (struct inet_proto *) proto4, proto4_len);
}
