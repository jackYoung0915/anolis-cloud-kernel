...
static void _resctrl_offline_mon_domain(struct rdt_resource *r, struct rdt_domain *d)
{
	lockdep_assert_held(&rdtgroup_mutex);
...
static int _resctrl_online_mon_domain(struct rdt_resource *r, struct rdt_domain *d)
{
	int err;
